...
"""Regression guard: visual QA must decode VP9 media.

The super-resolution stage now emits VP9-encoded video (per the ``main`` codec
policy). These tests fail if the visual QA decode paths (OpenCV probing and the
...
from visual_qa import media  # noqa: E402 - imported after the OpenCV availability gate.
from visual_qa.media import MediaWindow, extract_window_frames  # noqa: E402
